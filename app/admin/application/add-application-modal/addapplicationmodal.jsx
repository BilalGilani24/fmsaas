...
const Addapplicationmodal = ({ setcreateapplicationmodal, applicationID }) => {
      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form onSubmit={handleSubmit(createstudentapplicatin)} className="container px-4 mx-auto p-3">
            <div className="max-w-md mx-auto px-8 py-6 bg-gray-100 rounded-lg shadow-sm border">
              <div className="mb-4">
                <label className="block text-gray-800 mb-1">University</label>
                <input
                  {...register("Universityname")}
                  className="w-full px-4 py-2 rounded-sm focus:outline-none focus:ring-2 focus:ring-yellow-300 transition duration-300"
