  ...
  return (
    <>
      ...
      <div className="mb-5 mt-5 ml-64">
        <ul className="items-center dm-sans w-[1000px] text-center text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
