    ...
    <div className=" absolute mt-[500px] ml-64  ">
      <div className="flex flex-col  ">
        <div className="grid grid-cols-2  grid-rows-1 gap-5  ">
          <div className="bg-white  h-auto w-[650px] dm-sans border mt-[-140px] p-5 mb-5 rounded-lg shadow-lg">
            ...
            <div id="input" className="relative justify-end flex mt-[-20px]">
              <button
                ...
                type="button"
              >
                <div className="flex gap-2 items-center">Create Student</div>
              </button>
            </div>
          </div>
          <div>
