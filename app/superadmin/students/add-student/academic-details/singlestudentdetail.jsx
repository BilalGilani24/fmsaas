...
const Singlestudentdetail = ({ getacademic,getstudentacademic  }) => {
  ...
  return (
    <div>
      <div className="relative w-[1000px] dm-sans mt-5  overflow-x-auto sm:rounded-lg">
          ...
          <tbody>
            {getacademic.map((item, index) =>
              item.id == getid ? (
                <tr
                  key={index}
                  className="bg-white/10 text-white backdrop-blur-xl hover:bg-white/15 border-white/20 shadow-xl"
                >
