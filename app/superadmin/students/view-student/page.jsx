    ...
    <div className="flex flex-col dm-sans">
      ...
      <div className=" ml-[940px] mt-3">
        <form class="max-w-sm mx-auto">
          ...
          >
            Select Branch{" "}
            <strong className="text-blue-500">(Branch Wise Student)</strong>
          </label>
          <select
            id="countries"
          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                  ...
                  <form className="w-32">
                    <select
                      id="countries"
                      class="bg-gray-50 border-purple-600 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >
                      <option selected>Choose status</option>
                      <option value="US">ShortListing Fixed</option>
                      <option value="CA">Document</option>
                      <option value="FR">University Shortlisting</option>
                      <option value="DE">Document Sending</option>
                      <option value="DE">University List Sent</option>
                      <option value="DE">Doc pending</option>
                      <option value="DE">Intrested</option>
                      <option value="DE">Not Intrested</option>
                    </select>
                  </form>
                </td>
                <td>
              ...
              <tr class="bg-white border-b  dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">0332-22232</td>
                <td class="px-6 py-4">
                  {" "}
                  <form className="w-32">
                    <select
                ...
                <td>
                  <div className="px-6 py-2  text-black  rounded-lg    bg-red-500 cursor-pointer">
                    Pending
                  </div>
                </td>
              ...
              <tr class="bg-white dark:bg-gray-800">
                ...
                <td class="px-6 py-4">033302292-2</td>
                <td class="px-6 py-4">
                  {" "}
                  <form className="w-32">
                    <select
                      id="countries"
                      class="bg-gray-50 border-purple-600 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    >
                      <option selected>Choose status</option>
                      <option value="US">ShortListing Fixed</option>
                      <option value="CA">Document</option>
