...
const Profilesection = () => {
  ...
  return (
    <div className="mt-10 justify-center items-center">
      ...
      <div class="group border before:hover:scale-95 before:hover:h-[500px] before:hover:w-[500px] before:hover:h-[500px] before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-[500px] before:h-52 before:rounded-t-2xl before:bg-gradient-to-bl from-sky-200 via-orange-200 to-red-500 before:absolute before:top-0 w-[500px] h-[500px] relative bg-slate-50 flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
        <div
          style={{
        ...
        <div class="z-10  dm-sans group-hover:-translate-y-10 transition-all duration-500">
          <span class="text-2xl font-semibold">Bilal Gilani</span>
          <p className=" font-semibold">Student Consular</p>
          <p className=" font-semibold">Islamabad Office</p>
          <p className=" font-semibold">bilalshoaib644@gmail.com</p>
        </div>
        <button
      ...
      {isExploding && (
        <div className="flex justify-center items-center ">
          <div
            aria-hidden="true"
            class=" overflow-y-auto ml-[417px] dm-sans mt-52  overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
          >
