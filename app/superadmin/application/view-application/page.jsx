    ...
    <div className="flex flex-col dm-sans">
      ...
      <div className=" ml-[940px]  mt-3">
        <form class="max-w-sm mx-auto">
          ...
          >
            Select Branch{" "}
            <strong className="text-blue-500">(Branch Wise Application)</strong>
          </label>
          <select
            id="countries"
          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs border  text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" class="px-6 py-3">
                  <div className="w-40">Intrested Countries</div>
                </th>
                <th scope="col" class="px-6 py-3 ">
                  <div className="w-32">Passport Number</div>
                </th>
                <th scope="col" class="px-6 py-3">
            ...
            <tbody>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">bilalshoaib644@gmail.com</td>
                <td class="px-6 py-4">03329792617</td>
                <td class="px-4 py-2  ">
                  <div className="flex mt-[-20px] flex-row gap-2">
                    <div className="px-8 py-2 h-9 w-40 text-black  rounded-lg  mt-4  bg-lamaPurple cursor-pointer">
                      2 Applications
                    </div>
                    <div className="px-4 py-2 h-9 w-40  text-black  rounded-lg  mt-4  bg-lamaSky cursor-pointer">
                      + Add Applications
                    </div>
                  </div>
                </td>
                <div className="p-2 text-center  text-black  rounded-lg  mt-4  bg-green-400 cursor-pointer">
                  Submitted
                </div>
              ...
              <tr class="bg-white border-b  dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">03329792617</td>
                <td class="px-4 py-2  ">
                  <div className="flex mt-[-10px] flex-row gap-2">
                    <div className="px-8 py-2 h-9 w-40 text-black  rounded-lg  mt-3  bg-lamaPurple cursor-pointer">
                      2 Applications
                    </div>
                    <div className="px-4 py-2 h-9 w-40  text-black  rounded-lg  mt-3  bg-lamaSky cursor-pointer">
                      + Add Applications
                    </div>
                  </div>
                </td>
                <div className=" p-2 text-center  text-black  rounded-lg  mt-5  bg-red-500 cursor-pointer">
                  Pending
                </div>
              ...
              <tr class="bg-white dark:bg-gray-800">
                ...
                <div className=" p-2 text-center  text-black  rounded-lg  mt-4  bg-red-500 cursor-pointer">
                  Pending
                </div>
